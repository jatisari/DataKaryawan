...
public class MainActivity extends ActionBarActivity {
    ...
    private void initUI() {
        ...
        TextView textViewNIK = (TextView) findViewById(R.id.textViewNIK);
    ...
    private void initData(){
        ...
        categories.add("Junior Programmer");
        categories.add("Senior Programmer");
        categories.add("Supervisor");
        categories.add("Manager");
        categories.add("General Manager");
        categories.add("CEO");
    ...
    private void readForm() {
       // Log.d(TAG,"readForm");
        ...
        hobi="";
        if (checkBoxOlahraga.isChecked()){hobi+=""+checkBoxOlahraga.getText();}
        if (checkBoxBaca.isChecked()){hobi+=","+checkBoxBaca.getText();}
        if (checkBoxNonton.isChecked()){hobi+=","+checkBoxNonton.getText();}
